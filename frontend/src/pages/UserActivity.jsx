...
import { ShoppingBag, Star, Calendar, Package, ArrowLeft, MapPin, Phone, CreditCard, XCircle } from 'lucide-react';
    ...
    return (
        <div className="max-w-7xl mx-auto px-4 md:px-8 pt-28 pb-16 font-sans bg-slate-50 min-h-screen">
            <div className="flex flex-col lg:flex-row gap-8 items-start">
                ...
                <div className="w-full lg:w-64 bg-white rounded-3xl p-6 border border-slate-100 shadow-sm space-y-6 shrink-0">
                ...
                <div className="flex-1 w-full bg-white rounded-3xl p-6 lg:p-8 border border-slate-100 shadow-sm">
